...
export const memoryShards = [
  {
    title: "Note for My Dearest Leann #1",
    text: "Watching you collect those snowflakes made me smile so much. It reminded me of how your eyes quietly, gently, and unexpectedly captured my heart. You have this soft magic about you, the kind that makes everything feel warmer, calmer, and a little more beautiful just by being there. ❄️", 
  },
  {
    title: "Note for My Dearest Leann #2",
    text: "I really, really love the way your mind works, dear. The way you think, care, and feel so deeply. Even when the world gets heavy and you feel tired, you still shine in the most beautiful way. You don’t even realize it, but your light makes the days better just by existing. I’m so proud of you, always, mwaa! 😘", 
  },
  {
...
export const notes = [
  "I love you more than fries love salt. (you're my BBQ and Sour Cream kasi haha.)",
...
export const riddles = [
  ...
  },
  {
    ...
    choices: ['Kinda like u', 'Love you dear', 'Need more fries', 'Want a nap'],
    correctIndex: 1,
    hint: 'Precious thing that came from heart.',
  },
  {
    question: 'What do you call a date with you + me + Christmas lights?',
    choices: ['A perfect night', 'A tangled mess', 'A coffee run', 'A coding sprint'],
    correctIndex: 0,
    hint: 'Warm, sweet, simple, like you.',
  },
]
